...
namespace Services
{
    ...
    public class BookService
    {
        ...
        /// <returns></returns>
        public List<Book> SearchBooks(string keyword, int caterory)
        {
            List<Book> list = _repo.GetAll().Where(b => (b.BookName.ToLower().Contains(keyword.ToLower()) ||
                                             b.Description.ToLower().Contains(keyword.ToLower())) && b.BookCategoryId == caterory).ToList();
