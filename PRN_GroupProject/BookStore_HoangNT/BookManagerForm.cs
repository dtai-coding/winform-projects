...
namespace BookStore_TaiPD
{
    public partial class BookManagerForm : Form
    {
        ...
        private void BookManagerForm_Load(object sender, EventArgs e)
        {
            ...
            cbCatergorySearch.DataSource = _categoryService.GetAllCategories();
            cbCatergorySearch.DisplayMember = "BookGenreType";
            cbCatergorySearch.ValueMember = "BookCategoryId";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var result = _bookService.SearchBooks(txtKeyword.Text.Trim(), int.Parse(cbCatergorySearch.SelectedValue.ToString()));
